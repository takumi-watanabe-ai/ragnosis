-- ============================================================================
-- Google Trends Analysis Functions
-- Deploy this file to Supabase SQL Editor
-- ============================================================================

-- ============================================================================
-- PRIVATE SCHEMA (Internal Business Logic)
-- ============================================================================
...
-- ============================================================================
-- Functions created:
-- - private.get_trends_time_series_internal()
-- - private.get_aggregated_trends_internal()
-- - private.get_top_trending_keywords_internal(p_limit)
-- - public.get_trends_time_series()
-- - public.get_aggregated_trends()
-- - public.get_top_trending_keywords(p_limit)
-- ============================================================================
